                                                                ...
                                                                <div className={"flex w-full items-end"}>
                                                                    <div className={`relative h-11 w-full min-w-[200px]`} >
                                                                        <input
                                                                            ...
                                                                            className="text-[16px] peer h-full w-full rounded-none border-b border-gray-300 bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 placeholder:opacity-0 focus:placeholder:opacity-100"/>
                                                                        <label
