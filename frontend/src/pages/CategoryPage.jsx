                    ...
                    <div className={"w-full flex flex-wrap justify-center pt-3"}>
                        {
                            data.products.length !== 0 ? (
                                data.products.map(function (product) {
                                    return (
                                        <ProductItem key={product._id} product={product} windowInnerWidth={windowInnerWidth}/>
                                    )
                                })
                            ) : (
                                <div className={"p-4"}>
                                    <Message variant={"warning"}>It appears we dont have what you are looking for at the moment :(</Message>
                                </div>
                            )
                        }
                    </div>
