...
const AdminCreateProductPage = () => {
    ...
    return (
        <>
            ...
            <BackButton/>
            <div className={"2xl:px-20 pt-4"}>
                <div className={"bg-white mx-auto w-full"}>
                    <h2 className={"py-2 text-center text-3xl md:text-2xl font-semibold ibmplex bg-white md:bg-neutral md:text-white"}>
                        New Product Listing
                    </h2>
                            ...
                            <div className={"flex flex-col lg:flex-row"}>
                                <div className={"w-full flex flex-col lg:w-6/12 sm:px-10 lg:pr-10 lg:pl-5"}>
                                    <div className={"space-y-2 pb-2"}>
                                        ...
                                        <textarea
                                            className={`bg-white w-full text-base px-4 py-2 border  border-gray-300 rounded-sm focus:outline-none focus:border-blue-400 ${newProduct && "border-none bg-base-100 font-semibold"}`}
                                            autoComplete={"off"}
                                            // type={"text"}
                                        ...
                                        <div className={"w-full flex flex-col lg:w-6/12 lg:px-2"}>
                                            <div className={"w-full flex flex-row lg:flex-col"}>
                                                ...
                                                <div className={"bg-white w-full pl-5 lg:pl-0 space-y-2 pb-2"}>
                                                    ...
                                                    <input
                                                        className={`w-full text-base px-4 py-2 border border-gray-300 rounded-sm focus:outline-none focus:border-blue-400 ${newProduct && "border-none bg-base-100 font-semibold"}`}
                                                        autoComplete={"off"}
                                                        type={"number"}
